...
public class ComposevApp {
	...
	public static void usage() {
		System.out
				.println("java ComposevApp vCloudURL user@organization password orgname vdcname vapptemplatename CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java ComposevApp https://vcloud user@Organization password orgname vdcname vapptemplatename");
		System.out
				.println("java ComposevApp https://vcloud user@Organization password orgname vdcname vapptemplatename certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

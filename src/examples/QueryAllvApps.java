...
public class QueryAllvApps {
	...
	public static void usage() {
		System.out
				.println("java QueryAllvApps vCloudURL user@organization password CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java QueryAllvApps https://vcloud user@System password");
		System.out
				.println("java QueryAllvApps https://vcloud user@System password certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

...
public class ImportVmAsvAppTemplate {
	...
	public static void usage() {
		System.out
				.println("java ImportVmAsvAppTemplate vCloudURL user@organization password orgname vdcname vspherename vmname CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java ImportVmAsvAppTemplate https://vcloud user@Organizaiton password orgname vdcname vspherename vmname");
		System.out
				.println("java ImportVmAsvAppTemplate https://vcloud user@Organizaiton password orgname vdcname vspherename vmname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

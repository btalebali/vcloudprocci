...
public class VdcCRUD {
	...
	public static void usage() {
		System.out
				.println("java VdcCRUD Vcloud user@organization password OrgName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java VdcCRUD https://vcloud username@Organization password orgname");
		System.out
				.println("java VdcCRUD https://vcloud username@Organization password orgname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

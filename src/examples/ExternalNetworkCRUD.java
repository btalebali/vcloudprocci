 ...
 * 
 * Should be system administrator. A vSphere port group should be available. If
 * the port group uses VLAN, it can use only a single VLAN. Port groups with
 * VLAN trunking are not supported.
 * 
 * @since SDK 5.1
...
public class ExternalNetworkCRUD {
	...
	public static void usage() {
		System.out
				.println("java ExternalNetworkCRUD Vcloud user@organization password VimServerName PortGroupName ExternalNetworkName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
		...
		System.out
				.println("java ExternalNetworkCRUD https://vcloud username@Organization password vimservername portgroupname externalnetworkname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
	...
	public static void main(String args[]) throws VCloudException,
		...
		externalNetwork = externalNetwork
				.updateVMWExternalNetwork(vmwExternalNetworkForUpdate);
		...
		System.out
				.println("	"
						+ VMWExternalNetwork.getVMWExternalNetworkByReference(

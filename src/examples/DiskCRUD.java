...
public class DiskCRUD {
	...
	private static void usage() {
		System.out
				.println("java DiskCRUD VcloudUrl Username@vcloud-oragnization Password OrganizationName vAppName vmName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java DiskCRUD https://vcloud username@Organization password orgName vappName vmName");
		System.out
				.println("java DiskCRUD https://vcloud username@Organization password orgName vappName vmName certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

...
public class GroupCRUD {
	...
	public static void usage() {
		System.out
				.println("java GroupCRUD VcloudUrl Username@vcloud-organization Password OrgName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java GroupCRUD https://vcloud user@Organization password orgname");
		System.out
				.println("java GroupCRUD https://vcloud user@Organization password orgname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
	...
	public static void main(String args[]) throws HttpException,
			...
			UnrecoverableKeyException, KeyStoreException, TimeoutException, CertificateException {

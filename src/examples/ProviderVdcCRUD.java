 ...
 * 
 * Should be system administrator. Should contain atleast a vCenter with
 * resource pools.
 * 
...
public class ProviderVdcCRUD {
	...
	public static void usage() {
		System.out
				.println("java ProviderVdcCRUD Vcloud user@organization password VimServerName ResourcePoolName StorageProfileName ProviderVdcName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
		...
		System.out
				.println("java ProviderVdcCRUD https://vcloud username@Organization password vimservername resourcepoolname storageprofilename providervdcname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
	...
	public static void main(String args[]) throws VCloudException,
		...
		if (resourcePool != null) {
			...
			vMWProviderVdc = vMWProviderVdc
					.updateVMWProviderVdc(vmwProviderVdc);

...
public class RoleCRUD {
	...
	public static void usage() {
		System.out
				.println("java RoleCRUD VcloudUrl Username@vcloud-oragnization Password CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java RoleCRUD https://vcloud user@Organization password");
		System.out
				.println("java RoleCRUD https://vcloud user@Organization password certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

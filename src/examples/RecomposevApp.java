...
public class RecomposevApp {
	...
	private static void usage() {
		System.out
				.println("java RecomposevApp vCloudURL user@organization password orgname vdcname vdcName2 vappName vappName vmName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java RecomposevApp https://vcloud user@Organization password orgname vdcname2(whereTheToBeRecomposedVappExists) vdcName(whereTheToBeAddedVmExists) toBeRecomposedvAppName vAppNameContainingToBeAddedVm vmName");
		System.out
				.println("java RecomposevApp https://vcloud user@Organization password orgname vdcname2(whereTheToBeRecomposedVappExists) vdcName(whereTheToBeAddedVmExists) toBeRecomposedvAppName vAppNameContainingToBeAddedVm vmName certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
	...
	public static void main(String args[]) throws HttpException,
			...
			KeyStoreException, TimeoutException, CertificateException {

...
public class BlankVMs {
	...
	public static void usage() {
		System.out
				.println("java BlankVMs VcloudUrl Username@vcloud-organization Password orgName vdcName newVappTemplateName existingCatalogName newVappName newVmName noOfBlankVms CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java BlankVMs https://vcloud user@Organization password orgname vdcname newvapptemplatename existingcatalogname newvappname newvmname noofblankvms");
		System.out
				.println("java BlankVMs https://vcloud user@Organization password orgname vdcname newvapptemplatename existingcatalogname newvappname newvmname noofblankvms certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
	...
	public static void main(String args[]) throws VCloudException,
			...
			UnrecoverableKeyException, KeyStoreException, InterruptedException, CertificateException {
		...
		if (args.length == 12) {
			System.setProperty("javax.net.ssl.trustStore", args[10]);
			System.setProperty("javax.net.ssl.trustStorePassword", args[11]);
		...
		if(catalogRef != null) {
			...
			System.out.println("Catalog not found :: " + catalogName);
			System.exit(0);
		}

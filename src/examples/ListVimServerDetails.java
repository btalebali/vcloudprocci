...
public class ListVimServerDetails {
	...
	public static void usage() {
		System.out
				.println("java ListVimServerDetails vCloudURL user@organization password CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java ListVimServerDetails https://vcloud user@System password");
		System.out
				.println("java ListVimServerDetails https://vcloud user@System password certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

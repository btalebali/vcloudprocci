...
public class CatalogCRUD {
	...
	public static void usage() {
		System.out
				.println("java CatalogCRUD VcloudUrl Username@vcloud-organization Password OrgName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java CatalogCRUD https://vcloud user@Organization password orgname");
		System.out
				.println("java CatalogCRUD https://vcloud user@Organization password orgname certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

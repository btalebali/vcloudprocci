...
public class OrganizationCRUD {
	...
	public static void usage() {
		System.out
				.println("java OrganizationCRUD VcloudUrl Username@vcloud-organization Password CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java OrganizationCRUD https://vcloud user@Organization password");
		System.out
				.println("java OrganizationCRUD https://vcloud user@Organization password certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}

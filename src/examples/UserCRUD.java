...
public class UserCRUD {
	...
	public static void usage() {
		System.out
				.println("java UserCRUD VcloudUrl user@organization password OrgName CertificateKeyStorePath[optional] CertificateKeyStorePassword[optional]");
		System.out
				.println("java UserCRUD https://vcloud user@organization password orgName");
		System.out
				.println("java UserCRUD https://vcloud user@organization password orgName certificatekeystorepath certificatekeystorepassword");
		System.exit(0);
	}
